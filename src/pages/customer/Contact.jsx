    ...
    <section className="container-page py-10">
      <div className="grid gap-6 md:grid-cols-2">
        <div className="rounded-3xl bg-white p-7 shadow-sm">
          <h1 className="text-3xl font-black">Contact Pehnawa Collection Dungar</h1>
          <p className="mt-4 leading-7 text-slate-600">Email hello@pehnawacollection.com or WhatsApp +91 98765 43210 for product inquiries, returns, and store support.</p>
        </div>
