      ...
      <header className="sticky top-0 z-50 border-b border-slate-200 bg-white md:hidden">
        <div className="flex h-14 items-center justify-between px-3">
          ...
          <button onClick={() => navigate('/')} className="flex-1">
            <img src={logo} alt="Pehnawa Collection Dungar" className="mx-auto h-11 w-auto" />
          </button>
        ...
        <div className="px-3 pb-3">
          <button onClick={() => navigate('/search')} className="flex h-11 w-full items-center gap-2 rounded bg-[#F5F5F6] px-4 text-sm font-semibold text-slate-500">
